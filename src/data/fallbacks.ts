...
export const FALLBACK_QUESTIONS: Record<string, Record<string, Record<number, unknown[]>>> = {
  memory_master: {
    ...
    story_details: {
      1: [
        { story: 'The dog ran to the park. He found a red ball. He brought it to his friend Sam.', questions: [{ question: 'What color was the ball?', choices: ['Red', 'Blue', 'Green'], correct_answer: 'Red' }, { question: 'Who did the dog bring the ball to?', choices: ['Sam', 'Mom', 'Cat'], correct_answer: 'Sam' }] },
        { story: 'Emma ate a banana for lunch. Then she drank some milk. She was very happy.', questions: [{ question: 'What did Emma eat?', choices: ['Banana', 'Apple', 'Cookie'], correct_answer: 'Banana' }, { question: 'What did she drink?', choices: ['Milk', 'Juice', 'Water'], correct_answer: 'Milk' }] },
      ],
      2: [{ story: 'The cat climbed the tall tree. A bird was sitting on a branch. The cat wanted to play. The bird flew away quickly.', questions: [{ question: 'Where was the bird?', choices: ['On a branch', 'On the ground', 'In a nest'], correct_answer: 'On a branch' }, { question: 'What did the bird do?', choices: ['Flew away', 'Sang a song', 'Fell down'], correct_answer: 'Flew away' }] }],
      3: [{ story: 'The cat climbed the tall tree. A bird was sitting on a branch. The cat wanted to play. The bird flew away quickly.', questions: [{ question: 'Where was the bird?', choices: ['On a branch', 'On the ground', 'In a nest'], correct_answer: 'On a branch' }, { question: 'What did the bird do?', choices: ['Flew away', 'Sang a song', 'Fell down'], correct_answer: 'Flew away' }] }],
    },
  },
  word_wizard: {
    riddles: {
