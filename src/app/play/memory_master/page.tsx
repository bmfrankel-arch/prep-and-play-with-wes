...
const subGames = [
  { id: 'remember_list', name: 'Remember the List', emoji: '📝', desc: 'Memorize and recall!' },
  { id: 'order_recall', name: 'Order Recall', emoji: '🔢', desc: 'Remember the sequence!' },
  { id: 'story_details', name: 'Story Details', emoji: '📖', desc: 'Listen and remember!' },
];

export default function MemoryMasterPage() {
  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <div className="text-center mb-8">
        <BadgeDisplay skillArea="memory_master" level={level} size="lg" />
        <h1 className="text-3xl font-extrabold text-navy mt-4">Memory Master</h1>
      ...
      <div className="max-w-md mx-auto space-y-4">
        {subGames.map(sg => (
          <button
            key={sg.id}
            onClick={() => router.push(`/play/memory_master/${sg.id}`)}
